...
export default function GoogleMap({ className = "w-full min-h-[350px] md:h-full" }: { className?: string }) {
    return (
        <div className={`relative overflow-hidden ${className}`}>
            ...
            <div className="absolute inset-0 bg-[#1a1613]">
                <iframe
                    ...
                    className="w-full h-full grayscale invert-[0.9] contrast-[1.2] brightness-[0.9] hue-rotate-[180deg]"
                    style={{ border: 0 }}
