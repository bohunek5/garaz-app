            ...
            <main className="max-w-[1280px] mx-auto px-4 md:px-10 lg:px-20 py-6 flex flex-col gap-12 md:gap-24">
                ...
                <nav className="flex items-center justify-between py-6">
                    <div className="flex items-center gap-3 cursor-pointer">
                        <div className="flex items-center justify-center rounded bg-primary p-1.5 text-black">
                    ...
                    <div className="hidden md:flex gap-4">
                        <button className="text-white border border-gray-600 hover:border-white rounded-lg px-4 py-2 text-sm font-medium transition-colors">
                            Panel Klienta
                        </button>
                    </div>
                ...
                <section className="relative w-full rounded-3xl overflow-hidden min-h-[600px] flex items-center bg-black">
                    ...
                    <div className="relative z-10 px-8 md:px-16 flex flex-col gap-8 max-w-3xl">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mt-2">
                            <button className="h-12 px-8 rounded-lg bg-primary hover:bg-orange-600 text-white font-bold text-sm shadow-lg shadow-orange-900/20 transition-all flex items-center justify-center gap-2">
                                Zarezerwuj termin
                                <span className="material-symbols-outlined text-[20px]">calendar_month</span>
                            </button>
                            <button className="h-12 px-8 rounded-lg bg-[#23170f]/80 backdrop-blur-sm border border-gray-600 hover:bg-gray-800 text-white font-medium text-sm transition-all flex items-center justify-center">
                                Zobacz cennik
                            </button>
                        </div>
                ...
                <section className="flex flex-col lg:flex-row gap-8 rounded-2xl bg-[#23170f] border border-[#3a2f27] overflow-hidden">
                    ...
                    <div className="flex-1 min-h-[400px] lg:min-h-auto relative bg-[#1a1613]">
                        <div className="absolute inset-0 w-full h-full">
                            <img
                                src="/garaz-app/map-bg.png"
                                alt="Map location view of Sybiraków 28 Giżycko"
                                className="w-full h-full object-cover opacity-80 bg-blend-overlay"
                            />
